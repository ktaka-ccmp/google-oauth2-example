...
1. React.js app regards the user as authenticated and sets a property to always send the session cookie in the following communications with the Django API server.
1. The Django API allows what is allowed for the user as long as the session is valid.
